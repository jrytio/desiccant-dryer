...
| Hardware test | `esphome/desiccant-dryer-hw-test.yaml` | Same real sensors, dev credentials and OTA | ESP32-S2 |
...
others interact with it over a network (the web server, the API), the AGPL requires you to offer them your source.
